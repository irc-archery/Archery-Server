...
router.get('/', loginCheck, function(req, res) {
	...
	connection.query(extractOrganizationIdSql, function(err, extractOrganizationIdResults) {
		...
		var userRecordSql = 'select sc_id, created from scoreCard where p_id = ' + connection.escape(p_id) + ' order by created desc limit 5';
