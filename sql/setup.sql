...
create table `scorePerEnd` (
	...
	`o_id` int,
	`perEnd` int,
	`score_1` varchar(5) default '',
	`score_2` varchar(5) default '',
	`score_3` varchar(5) default '',
	`score_4` varchar(5) default '',
	`score_5` varchar(5) default '',
	`score_6` varchar(5) default '',
	`updatedScore_1` varchar(5) default '',
	`updatedScore_2` varchar(5) default '',
	`updatedScore_3` varchar(5) default '',
	`updatedScore_4` varchar(5) default '',
	`updatedScore_5` varchar(5) default '',
	`updatedScore_6` varchar(5) default '',
	`subTotal` int,
	index(`spe_id`),
